...
DUNE::Tasks::Task* createActuatorsDiceTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createActuatorsRaspberryPiPWMTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createControlASVAutopilotTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createControlASVHeadingAndSpeedTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createControlASVRemoteOperationDifferentialThrustTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createControlASVRemoteOperationThrusterAndRudderTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createControlPathCASTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createManeuverVehicleFormationSwarmTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsBootTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsCPUScalingTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createMonitorsHostResourcesTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsLogTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createMonitorsNavErrorTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsNavigationLightTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsOperationalLimitsTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsPayloadTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsServosTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsThrustersTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createMonitorsZeroTierTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createNavigationGeneralEstimatorTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createNavigationGeneralNavManagerTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createPowerWRPDTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSensorsRaspberryPiSenseHatv2Task(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSensorsWT901CTask(const std::string&, DUNE::Tasks::Context&);
DUNE::Tasks::Task* createSensorsWaterLinkedDVLTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSimulatorsAutopilotTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSimulatorsHeaveTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSupervisorsAutonautTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSupervisorsGroundingTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createSupervisorsStarLinkTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createTransportsIridiumOperationTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Task* createTransportsSMSTask(const std::string&, DUNE::Tasks::Context&);
...
DUNE::Tasks::Factory::registerStaticTask("Actuators.Dice", createActuatorsDiceTask);
...
DUNE::Tasks::Factory::registerStaticTask("Actuators.RaspberryPiPWM", createActuatorsRaspberryPiPWMTask);
...
DUNE::Tasks::Factory::registerStaticTask("Control.ASV.Autopilot", createControlASVAutopilotTask);
DUNE::Tasks::Factory::registerStaticTask("Control.ASV.HeadingAndSpeed", createControlASVHeadingAndSpeedTask);
DUNE::Tasks::Factory::registerStaticTask("Control.ASV.RemoteOperation.DifferentialThrust", createControlASVRemoteOperationDifferentialThrustTask);
DUNE::Tasks::Factory::registerStaticTask("Control.ASV.RemoteOperation.ThrusterAndRudder", createControlASVRemoteOperationThrusterAndRudderTask);
...
DUNE::Tasks::Factory::registerStaticTask("Control.Path.CAS", createControlPathCASTask);
...
DUNE::Tasks::Factory::registerStaticTask("Maneuver.VehicleFormation.Swarm", createManeuverVehicleFormationSwarmTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.Boot", createMonitorsBootTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.CPUScaling", createMonitorsCPUScalingTask);
...
DUNE::Tasks::Factory::registerStaticTask("Monitors.HostResources", createMonitorsHostResourcesTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.Log", createMonitorsLogTask);
...
DUNE::Tasks::Factory::registerStaticTask("Monitors.NavError", createMonitorsNavErrorTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.NavigationLight", createMonitorsNavigationLightTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.OperationalLimits", createMonitorsOperationalLimitsTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.Payload", createMonitorsPayloadTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.Servos", createMonitorsServosTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.Thrusters", createMonitorsThrustersTask);
DUNE::Tasks::Factory::registerStaticTask("Monitors.ZeroTier", createMonitorsZeroTierTask);
...
DUNE::Tasks::Factory::registerStaticTask("Navigation.General.Estimator", createNavigationGeneralEstimatorTask);
...
DUNE::Tasks::Factory::registerStaticTask("Navigation.General.NavManager", createNavigationGeneralNavManagerTask);
...
DUNE::Tasks::Factory::registerStaticTask("Power.WRPD", createPowerWRPDTask);
...
DUNE::Tasks::Factory::registerStaticTask("Sensors.RaspberryPiSenseHatv2", createSensorsRaspberryPiSenseHatv2Task);
...
DUNE::Tasks::Factory::registerStaticTask("Sensors.WT901C", createSensorsWT901CTask);
DUNE::Tasks::Factory::registerStaticTask("Sensors.WaterLinkedDVL", createSensorsWaterLinkedDVLTask);
...
DUNE::Tasks::Factory::registerStaticTask("Simulators.Autopilot", createSimulatorsAutopilotTask);
...
DUNE::Tasks::Factory::registerStaticTask("Simulators.Heave", createSimulatorsHeaveTask);
...
DUNE::Tasks::Factory::registerStaticTask("Supervisors.Autonaut", createSupervisorsAutonautTask);
...
DUNE::Tasks::Factory::registerStaticTask("Supervisors.Grounding", createSupervisorsGroundingTask);
...
DUNE::Tasks::Factory::registerStaticTask("Supervisors.StarLink", createSupervisorsStarLinkTask);
...
DUNE::Tasks::Factory::registerStaticTask("Transports.IridiumOperation", createTransportsIridiumOperationTask);
...
DUNE::Tasks::Factory::registerStaticTask("Transports.SMS", createTransportsSMSTask);
