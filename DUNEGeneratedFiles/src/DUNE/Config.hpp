...
#define DUNE_VERSION_STR "2026.01.0"
//! DUNE's private version string.
#define DUNE_PRIVATE_VERSION_STR "2026.01.0"
//! DUNE's version year.
#define DUNE_VERSION_YEAR 2026
...
//! DUNE's copyright.
#define DUNE_COPYRIGHT "Copyright (C) 2007-2026 - Universidade do Porto - LSTS"
//! DUNE's contact.
#define DUNE_CONTACT "DUNE <dune@lsts.pt>"
//! DUNE's build type.
#define DUNE_BUILD_TYPE "Release"
//! DUNE's system name.
#define DUNE_SYSTEM_NAME "x86-64bit-linux-glibc-gcc114"
//! DUNE's source path.
#define DUNE_PATH_SRC "/home/amilcar/workspace/dune/source"
//! DUNE's build path.
#define DUNE_PATH_BUILD "/home/amilcar/workspace/dune/source"
